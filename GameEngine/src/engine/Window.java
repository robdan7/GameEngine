...
import utils.rendering.Drawbuffer;
...
public class Window {
	...
	public void renderStaticShadowMap(Matrix4f mat, ShadowMap shadowmap) {
	...
	public void renderDynamicShadowMap(Matrix4f mat, ShadowMap shadowMap) {
		glBindFramebuffer(GL_FRAMEBUFFER, shadowMap.getBuffer().getColorMapFBO());
		glViewport(0, 0, shadowMap.getBuffer().SHADOW_MAP_WIDTH, shadowMap.getBuffer().SHADOW_MAP_HEIGHT);
		glClear(GL_DEPTH_BUFFER_BIT);
		int lastShader = 0;
	...
	public void renderTextured( Matrix4f mat, ShadowMap dynamicShadowMap) {
		int lastShader = 0;
		for (int i = 0; i < staticRenderStack.size(); i++) {
	...
	public void addStaticRenderObject(RenderObject obj) {
		this.staticRenderStack.add(obj);
	}
	
	public void addDynamicRenderObject(RenderObject obj) {
		this.dynamicRenderStack.add(obj);
	}
	
	public void deleteRenderObject(RenderObject obj) {
	...
	public void deleteAllRenderObjects() {
		for(int i = 0; i < staticRenderStack.size(); i++) {
